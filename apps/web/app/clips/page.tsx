...
function EmptyState() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h2 className="mb-2 text-xl font-semibold text-text-primary">{t("clips.noClipsYet")}</h2>
  ...
  if (!loading && user && hasCategories === false) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="mb-2 text-3xl font-bold text-text-primary">{"🎬 " + t("clips.title")}</h1>
          <p className="text-text-secondary">{t("clips.description")}</p>
        </div>
        <EmptyState />
      </div>
    );
